...
/**
 * Standalone feedback — add or edit a scorecard for an interview at any time,
 * independent of recording the final outcome. Doesn't change status or stage.
 */
export function FeedbackDialog({ open, onOpenChange, interview, onSubmit, isSubmitting }) {
  return (
...
function FeedbackForm({ interview, isSubmitting, onCancel, onSubmit }) {
  ...
  return (
    <>
      <div className="space-y-5">
        <div>
          <Label className="mb-1.5">Recommendation</Label>
          ...
          <p className="mt-1.5 text-xs text-muted-foreground">
            Feedback only — this does not change the interview outcome or the
            candidate's stage.
          </p>
        </div>
